...
class _TrainerAiToolsScreenState extends State<TrainerAiToolsScreen> {
  ...
  final audience = TextEditingController(
    text: 'retail and sales professionals',
  );
              ...
              children: [
                ...
                _section(context, 'Quiz creation', [
                  ...
                  Wrap(
                    ...
                    children: [
                      FilledButton(
                        onPressed: busy || quizId == null
                            ? null
                            : () => run(
                                () => api.generateAiQuestions(quizId!, 5),
                              ),
                        child: const Text('Preview 5 questions'),
                      ),
                      FilledButton.tonal(
                        onPressed: busy || quizId == null
                            ? null
                      ...
                      OutlinedButton(
                        onPressed: busy || quizId == null
                            ? null
                            : () => run(() => api.tagAiDifficulty(quizId!)),
                        child: const Text('Tag missing difficulty'),
                      ),
                    ],
                  ),
                ]),
                _section(context, 'Participant coaching', [
                  ...
                  DropdownButtonFormField<String>(
                    initialValue: store,
                    decoration: const InputDecoration(
                      labelText: 'Store knowledge-gap analysis',
                      border: OutlineInputBorder(),
                    ),
                    items: stores
                        .map(
                  ...
                  const SizedBox(height: 8),
                  TextField(
                    controller: nudgeContext,
                    maxLines: 2,
                    decoration: const InputDecoration(
                      labelText: 'Nudge context',
                      border: OutlineInputBorder(),
                    ),
                  ),
                  Wrap(
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        onPressed: busy || userId == null
                            ? null
                            : () => run(
                                () => api.getKnowledgeGaps(userId: userId),
                              ),
                        child: const Text('Participant gaps'),
                      ),
                      OutlinedButton(
                        onPressed: busy || store == null
                            ? null
                            : () => run(
                                () => api.getKnowledgeGaps(storeCode: store),
                              ),
                        child: const Text('Store gaps'),
                      ),
                      FilledButton.tonal(
                        onPressed: busy || userId == null
                            ? null
                      ...
                      FilledButton.tonal(
                        ...
                        child: const Text('Draft and notify'),
                      ),
                    ],
                  ),
                ]),
                ...
                if (output != null)
                  _section(context, 'Latest result', [
