...
class _ParticipantTasksScreenState extends State<ParticipantTasksScreen> {
  ...
  @override Widget build(BuildContext context) => LmsShell(
    ...
    body: _loading ? const LmsLoadingState(label: 'Loading your tasks') : _error != null ? LmsErrorState(message: 'We could not load your tasks.', onRetry: _load) : _tasks.isEmpty ? const LmsEmptyState(icon: Icons.task_alt, title: 'No active tasks', message: 'Tasks assigned by your trainer or manager will appear here.') : ListView.builder(
